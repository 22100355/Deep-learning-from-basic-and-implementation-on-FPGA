...
set DIR_SRC    $::env(LENET5_HOME)/LeNet-5.dlr/native.cpp/src
set DIR_TB     $::env(LENET5_HOME)/LeNet-5.dlr/native.cpp/src
set DIR_LIB    $::env(DLR_HOME)/src
set DIR_PARAMS $::env(LENET5_HOME)/LeNet-5.pytorch
set PNG [file normalize $::env(LENET5_HOME)/LeNet-5.pytorch/samples/t_00_c4.png]
