set moduleName lenet5_Pipeline_VITIS_LOOP_64_1_VITIS_LOOP_68_26
set isTopModule 0
...
set C_modelName {lenet5_Pipeline_VITIS_LOOP_64_1_VITIS_LOOP_68_26}
set C_modelType { void 0 }
set C_modelArgList {
	{ f1_out_data float 32 regular {array 120 { 1 3 } 1 1 }  }
	{ f2_out_data float 32 regular {array 84 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "f1_out_data", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "f2_out_data", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ f1_out_data_address0 sc_out sc_lv 7 signal 0 } 
	{ f1_out_data_ce0 sc_out sc_logic 1 signal 0 } 
	{ f1_out_data_q0 sc_in sc_lv 32 signal 0 } 
	{ f2_out_data_address0 sc_out sc_lv 7 signal 1 } 
	{ f2_out_data_ce0 sc_out sc_logic 1 signal 1 } 
	{ f2_out_data_we0 sc_out sc_logic 1 signal 1 } 
	{ f2_out_data_d0 sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "f1_out_data_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "f1_out_data", "role": "q0" }} , 
 	...
 	{ "name": "f2_out_data_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "f2_out_data", "role": "we0" }} , 
 	{ "name": "f2_out_data_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "f2_out_data", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc2_bias_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc2_weight_U", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "60495", "Max" : "60495"}
	, {"Name" : "Interval", "Min" : "60495", "Max" : "60495"}
]}
...
set Spec2ImplPortList { 
	f1_out_data { ap_memory {  { f1_out_data_address0 mem_address 1 7 }  { f1_out_data_ce0 mem_ce 1 1 }  { f1_out_data_q0 mem_dout 0 32 } } }
	f2_out_data { ap_memory {  { f2_out_data_address0 mem_address 1 7 }  { f2_out_data_ce0 mem_ce 1 1 }  { f2_out_data_we0 mem_we 1 1 }  { f2_out_data_d0 mem_din 1 32 } } }
}
set moduleName lenet5_Pipeline_VITIS_LOOP_64_1_VITIS_LOOP_68_26
set isTopModule 0
set isCombinational 0
