...
localparam
    ...
    ADDR_IER            = 5'h08,
    ADDR_ISR            = 5'h0c,
    ADDR_CLASSES_DATA_0 = 5'h10,
    ADDR_CLASSES_CTRL   = 5'h14,
    ADDR_IMAGE_R_DATA_0 = 5'h18,
    ADDR_IMAGE_R_CTRL   = 5'h1c,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_CLASSES_DATA_0: begin
                    rdata <= int_classes[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_CLASSES_DATA_0)
            int_classes[31:0] <= (WDATA[31:0] & wmask) | (int_classes[31:0] & ~wmask);
    end
end
